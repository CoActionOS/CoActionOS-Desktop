...
CNotification * CNotify::notificationPtr = 0;
CDebug * CNotify::debug = 0;
...
void CNotify::setUpdateObjects(QStatusBar * statusBar, QProgressBar * progressBar, CDebug * debug){
...
void CNotify::execWarning(QString msg){
    if( notificationPtr != 0 ){
        notificationPtr->setWarning(msg);
        return;
    }
...
int CNotify::execPrompt(QString msg){
    if( notificationPtr != 0 ){
        notificationPtr->setQuestion(msg);
        return 0;
    }
